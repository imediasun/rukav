            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="logo_name" name="logo_name" class="form-control" placeholder="Название логотипа компании">
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="logo_create btn btn-primary waves-effect waves-themed">Сохранить</button>
                </div>
            </div>
        </div>
                                   ...
                                   // $download.attr('href', result.toDataURL(uploadedImageType));
                                    ...
                                    /*$('#download').click(function(){*/
                                        ...
                                        $.ajax({
                                            ...
                                            dataType: 'json',
                                            async:false,
                                            url: '/admin/main_admin/company/logo/saveLogoToSession',
    ...
    <script>
        ...
        $('.logo_create').click(function(){
            ...
            $.ajax({
                ...
                dataType: 'json',
                async:false,
                url: '/admin/main_admin/company/logo/create',
                data: {company_id: company_id,logo_name: logo_name
                },
                beforeSend: function() {
                },
                complete: function() {
        ...
        function reloadData(){
            ...
            var url='/admin/main_admin/company/logo/data';
            $.ajax({
                method: 'POST',
                dataType: 'html',
                async:true,
