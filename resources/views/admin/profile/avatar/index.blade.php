        ...
        <div id="panel-7" class="panel">
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="panel-tag result_of_avatars_table">
        ...
        <div class="modal-dialog modal-dialog-right modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title h4">Форма добавления avatarа</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="form-label" for="avatar_name">Название аватара</label>
                        <input type="text" id="avatar_name" name="avatar_name" class="form-control" placeholder="Название avatarа компании">
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="avatar_create_close btn btn-secondary waves-effect waves-themed" data-dismiss="modal">Закрыть</button>
                    <button type="button" class="avatar_create btn btn-primary waves-effect waves-themed">Сохранить</button>
                </div>
            </div>
        </div>
    ...
    <div class="modal modal-al modal-alert fade" id="getCroppedCanvasModal" tabindex="-1" aria-labelledby="getCroppedCanvasTitle" role="dialog" aria-hidden="true" >
        <div class="modal-dialog modal-dialog-centered" >
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Осталось сохранит запись о avatarе...
                </div>
                <div class="modal-footer">
    ...
    <script>
        ...
        $('.avatar_create').click(function(){
            ...
            $.ajax({
                ...
                dataType: 'json',
                async:false,
                url: '/admin/main_admin/company/avatar/create',
                data: {user_id: user_id,avatar_name: avatar_name
                },
                beforeSend: function() {
                },
                complete: function() {
                    $('.avatar_create_close').click();
                    reloadData();
                },
                success: function (data) {
        ...
        function reloadData(){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('.result_of_avatars_table').html(data);
