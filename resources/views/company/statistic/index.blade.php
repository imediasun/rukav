...
@section('content')
    ...
    <div class="container">
        ...
        <div id="panel-7" class="panel">
            <div class="panel-hdr">
                <h2>
                    Таблица  <span class="fw-300"><i>популярности бейджей компании</i></span>
                </h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    <div class="form-group row">
                        <label class="col-form-label col-12 col-lg-3 form-label text-lg-right">Период для статистики</label>
                        <div class="col-12 col-lg-6">
                            <div class="input-daterange input-group" id="datepicker-5">
                                <input type="text" class="form-control start_date" value="03/01/2020" name="start">
                                <div class="input-group-append input-group-prepend">
                                    <span class="input-group-text fs-xl"><i class="fal fa-ellipsis-h"></i></span>
                                </div>
                                <input type="text" class="form-control finish_date" value="03/12/2020" name="end">
                                <button class="showStatistic">Вывести статистику</button>
                            </div>
    ...
    <script>
        ...
        function reloadData(){
            ...
            $.ajax({
                ...
                async:true,
                url: url,
                data: {module: module,start:start,finish:finish},
                beforeSend: function() {
                    $('#loader').show();
                },
                complete: function() {
