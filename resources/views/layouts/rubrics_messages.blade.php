...
<ul class="sky-mega-menu sky-mega-menu-response-to-icons sky-mega-menu-anim-scale">
    ...
    <li>
        ...
        <a class="Menu_giveBadgeWrap__28NpB" onclick="localStorage.setItem('personalBadegeCustomerId',0);/*reloadPage()*/localStorage.setItem('openAddMessageModal',1);window.location.href='/'"><i class="fal fa-edit"></i>Подать объявление</a>
    </li>
    <!--/ blog -->
