...
<aside class="page-sidebar">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card" style="display:block !important">
             <div class="info-card-text" style="display:block !important;text-align:center;margin-left:0px;margin-top:10px">
 ...
 <defs>
    ...
    .fil0 {fill:none}
         ...
         .fil3 {fill:white;fill-rule:nonzero}
                ...
                <span class="d-inline-block text-truncate text-truncate-sm" style="font-size: 18px;max-width:200px">Русские объявления <br>Британии</span>
            </div>
