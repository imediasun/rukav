...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="/NewSmartAdmin/css/miscellaneous/reactions/reactions.css">
    <link rel="stylesheet" media="screen, print" href="/NewSmartAdmin/css/miscellaneous/fullcalendar/fullcalendar.bundle.css">
    <link rel="stylesheet" media="screen, print" href="/NewSmartAdmin/css/miscellaneous/jqvmap/jqvmap.bundle.css">
</head>
<body class="mod-bg-4 ">
...
<script>
    ...
    localStorage.setItem("themeSettings", '{"themeOptions":"mod-bg-4","themeURL":"/NewSmartAdmin/css/themes/cust-theme-7.css"}');
    ...
    if (themeSettings.themeOptions)
    {
        ...
        console.log(classHolder.className)
    ...
    <div class="page-inner">
        ...
        <div class="page-content-wrapper">
            ...
            <header class="page-header" role="banner">
                ...
                <div class="page-logo">
                    <a href="#" class="page-logo-link press-scale-down d-flex align-items-center position-relative" data-toggle="modal" data-target="#modal-shortcut">
                        <img src="/NewSmartAdmin/imglogo.png" alt="SmartAdmin WebApp" aria-roledescription="logo">
                        <span class="page-logo-text mr-1">SmartAdmin WebApp</span>
                        <span class="position-absolute text-white opacity-50 small pos-top pos-right mr-2 mt-n2"></span>
                        <i class="fal fa-angle-down d-inline-block ml-1 fs-lg color-primary-300"></i>
                    </a>
                ...
                <div class="ml-auto d-flex">
                                    ...
                                    <div class="custom-scroll h-100">
                                        <ul class="notification">
                                            ...
                                            <li>
                                                <a href="#" class="d-flex align-items-center">
                                                            <span class="status status-success mr-2">
                                                                <!-- <img src="/NewSmartAdmin/imgdemo/avatars/avatar-m.png" data-src="/NewSmartAdmin/imgdemo/avatars/avatar-h.png" class="profile-image rounded-circle" alt="Sarah McBrook" /> -->
                                ...
                                <div class="tab-pane" id="tab-feeds" role="tabpanel">
                                    <div class="custom-scroll h-100">
                                        <ul class="notification">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center show-child-on-hover">
                                                    <!--<img src="/NewSmartAdmin/imgdemo/avatars/avatar-m.png" data-src="/NewSmartAdmin/imgdemo/avatars/avatar-k.png" class="profile-image rounded-circle" alt="k" />-->
                                                    <div class="d-flex flex-column flex-1">
                                                                <span class="name">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center show-child-on-hover">
                                                    <!--<img src="/NewSmartAdmin/imgdemo/avatars/avatar-m.png" data-src="/NewSmartAdmin/imgdemo/avatars/avatar-e.png" class="profile-image-sm rounded-circle align-self-start mt-1" alt="k" />-->
                                                    <div class="d-flex flex-column flex-1">
                                            ...
                                            <li>
                                                <div class="d-flex align-items-center show-child-on-hover">
                                                    <!--<img src="/NewSmartAdmin/imgdemo/avatars/avatar-m.png" data-src="/NewSmartAdmin/imgdemo/avatars/avatar-h.png" class="profile-image rounded-circle align-self-start mt-1" alt="k" />-->
                                                    <div class="d-flex flex-column flex-1">
                                                        <div class="name mb-2">
                    ...
                    <div>
                        <a href="#" data-toggle="dropdown" title="drlantern@gotbootstrap.com" class="header-icon d-flex align-items-center justify-content-center ml-2">
                            <img src="/NewSmartAdmin/imgdemo/avatars/avatar-admin.png" class="profile-image rounded-circle" alt="Dr. Codex Lantern">
                        ...
                        <div class="dropdown-menu dropdown-menu-animated dropdown-lg">
                            <div class="dropdown-header bg-trans-gradient d-flex flex-row py-4 rounded-top">
                                <div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
                                            <span class="mr-2">
                                                <img src="/NewSmartAdmin/imgdemo/avatars/avatar-admin.png" class="rounded-circle profile-image" alt="Dr. Codex Lantern">
                                            </span>
                                    <div class="info-card-text">
                                            ...
                                            <div class="h-100">
                                                ...
                                                <div class="d-flex flex-row px-3 pt-3 pb-2">
                                                    ...
                                                    <span class="status status-danger">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/NewSmartAdmin/imgdemo/avatars/avatar-j.png')"></span>
                                                            </span>
                                                    <!-- profile photo end -->
                                                    <div class="ml-3">
                                                ...
                                                <div class="d-flex flex-row px-3 pt-3 pb-2">
                                                    <!-- profile photo : lazy loaded -->
                                                    <span class="status status-danger">
                                                                <span class="profile-image rounded-circle d-inline-block" style="background-image:url('/NewSmartAdmin/imgdemo/avatars/avatar-admin.png')"></span>
                                                            </span>
                                                    <!-- profile photo end -->
                                                    <div class="ml-3">
                            ...
                            <div class="panel-container show">
                                ...
                                <div class="panel-content jqvmap-bg-ocean">
                                    <div class="d-flex align-items-center">
                                        <img class="d-inline-block js-jqvmap-flag mr-3 border-faded" alt="flag" src="https://lipis.github.io/flag-icon-/NewSmartAdmin/cssflags/4x3/us.svg" style="width:55px; height: auto;">
...
<script src="/NewSmartAdmin/js/dependency/moment/moment.js"></script>
<script src="/NewSmartAdmin/js/miscellaneous/fullcalendar/fullcalendar.bundle.js"></script>
<script src="/NewSmartAdmin/js/statistics/sparkline/sparkline.bundle.js"></script>
<script src="/NewSmartAdmin/js/statistics/easypiechart/easypiechart.bundle.js"></script>
<script src="/NewSmartAdmin/js/statistics/flot/flot.bundle.js"></script>
<script src="/NewSmartAdmin/js/miscellaneous/jqvmap/jqvmap.bundle.js"></script>
<script>
        ...
        $('#vector-map').vectorMap(
            {
                ...
                onRegionClick: function(element, code, region)
                {
                    ...
                    $('.js-jqvmap-flag').attr('src', 'https://lipis.github.io/flag-icon-/NewSmartAdmin/cssflags/4x3/' + code.toLowerCase() + '.svg');
